import{_ as W}from"./index-DVMIff0n.js";import{_ as F}from"./GiCellStatus.vue_vue_type_script_setup_true_lang-Dsi2Injn.js";import{_ as H}from"./index.vue_vue_type_script_setup_true_lang-8NeouZCX.js";import{_ as Q}from"./index.vue_vue_type_script_setup_true_lang-DNvpXvPA.js";import{b as g}from"./index-CAe3hmMw.js";import{c as X}from"./index-DBvjnvFZ.js";import{u as Y}from"./useTable-g4NRrMBs.js";import"./dept-DpQr_bkC.js";import{u as Z}from"./useDict-D3tXEd8u.js";import"./role-CQOef2Ft.js";import ee from"./index-8ccgDrhf.js";import{e as te,a7 as ne,r as ae,ae as oe,h as l,j as re,k as le,l as t,t as e,a1 as n,y as u,z as se}from"./vue-_iYK9Zi6.js";import{a9 as b}from"./arco-CDZlpuCh.js";const ie=`<template>\r
...
\r
    <a-table class="gi_table" row-key="id" :loading="loading" :bordered="{ cell: true }" :data="tableData"\r
      ...
      <template #columns>\r
        <a-table-column title="序号" :width="68">\r
...
`,De=te({__name:"Pane1",setup(ce){const d=ne(),{setTabTitle:h}=X(),{data:k}=Z({code:"status"}),i=ae({name:"",status:""}),{loading:C,tableData:D,getTableData:m,pagination:y,selectedKeys:p,select:T,selectAll:x,handleDelete:w,fixed:v}=Y(r=>g.getList({...i,...r}),{immediate:!1,formatResult:r=>r.map(a=>({...a,isEdit:!1}))}),A=r=>r<30?"danger":r<60?"warning":"success";oe(()=>{m()});const G=()=>{d.push({path:"/data/form"})},B=async()=>{await d.push({path:"/data/form",query:{id:"ID123456"}}),h("编辑")},I=r=>{d.push({name:"DataDetailId",params:{id:r.id}})},P=r=>w(()=>g.delete({ids:[r.id]}),{content:`是否删除-${r.name}?`,showModal:!1}),S=()=>{if(!p.value.length)return b.warning("请选择删除项！");w(()=>g.delete({ids:p.value}),{successTip:"批量删除成功！"})},M=()=>{if(!p.value.length)return b.warning("请勾选数据");b.success("点击了导出")};return(r,a)=>{const _=Q,E=H,f=l("a-space"),V=l("a-select"),$=l("a-input"),z=l("icon-search"),c=l("a-button"),L=l("a-input-group"),K=l("icon-refresh"),R=l("a-row"),s=l("a-table-column"),j=l("a-progress"),J=F,N=l("a-popconfirm"),q=l("a-table"),O=W;return le(),re(O,{collapsed:""},{left:t(()=>[e(ee,{placeholder:"请输入搜索关键词",onNodeClick:a[0]||(a[0]=o=>n(y).onChange(1))})]),default:t(()=>[e(R,{justify:"space-between"},{default:t(()=>[e(f,{wrap:""},{default:t(()=>[e(_,{type:"add",onClick:G}),e(_,{type:"delete",onClick:S}),e(_,{type:"export",onClick:M}),e(E,{code:n(ie)},null,8,["code"])]),_:1}),e(f,{wrap:""},{default:t(()=>[e(V,{modelValue:n(i).status,"onUpdate:modelValue":a[1]||(a[1]=o=>n(i).status=o),class:"gi_select_input",options:n(k),placeholder:"请选择","allow-clear":""},null,8,["modelValue","options"]),e(L,null,{default:t(()=>[e($,{modelValue:n(i).name,"onUpdate:modelValue":a[2]||(a[2]=o=>n(i).name=o),placeholder:"请输入搜索关键词","allow-clear":""},null,8,["modelValue"]),e(c,{type:"primary",onClick:n(m)},{default:t(()=>[e(z)]),_:1},8,["onClick"])]),_:1}),e(c,{type:"primary",onClick:n(m)},{icon:t(()=>[e(K)]),_:1},8,["onClick"])]),_:1})]),_:1}),e(q,{class:"gi_table","row-key":"id",loading:n(C),bordered:{cell:!0},data:n(D),scroll:{x:"100%",y:"100%",minWidth:1e3},"row-selection":{type:"checkbox",showCheckedAll:!0},pagination:n(y),"selected-keys":n(p),onSelect:n(T),onSelectAll:n(x)},{columns:t(()=>[e(s,{title:"序号",width:68},{cell:t(o=>[u(se(o.rowIndex+1),1)]),_:1}),e(s,{title:"姓名","data-index":"name"}),e(s,{title:"地址","data-index":"address",ellipsis:"",tooltip:""}),e(s,{title:"比例",width:200},{cell:t(({record:o})=>[e(j,{status:A(o.proportion),percent:o.proportion/100},null,8,["status","percent"])]),_:1}),e(s,{title:"状态",width:100,align:"center"},{cell:t(({record:o})=>[e(J,{status:o.status},null,8,["status"])]),_:1}),e(s,{title:"创建时间","data-index":"createTime",width:180}),e(s,{title:"操作",width:200,align:"center",fixed:n(v)},{cell:t(({record:o})=>[e(f,null,{default:t(()=>[e(c,{type:"primary",size:"mini",onClick:B},{default:t(()=>a[3]||(a[3]=[u("修改",-1)])),_:1,__:[3]}),e(c,{size:"mini",onClick:U=>I(o)},{default:t(()=>a[4]||(a[4]=[u("详情",-1)])),_:2,__:[4]},1032,["onClick"]),e(N,{type:"warning",content:"您确定要删除该项吗?",onBeforeOk:U=>P(o)},{default:t(()=>[e(c,{type:"primary",status:"danger",size:"mini"},{default:t(()=>a[5]||(a[5]=[u("删除",-1)])),_:1,__:[5]})]),_:2},1032,["onBeforeOk"])]),_:2},1024)]),_:1},8,["fixed"])]),_:1},8,["loading","data","pagination","selected-keys","onSelect","onSelectAll"])]),_:1})}}});export{De as _};
