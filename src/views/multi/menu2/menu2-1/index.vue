<template>
  <a-card :title="route.meta.title" class="g-page-card">
    <a-alert type="normal">
      <template #icon>
    ...
    <a-input v-model="inputValue" placeholder="请输入..." allow-clear :max-length="50" style="margin: 24px 0"></a-input>
  </a-card>
</template>
...
defineOptions({ name: 'MultiMenu2Menu21' })
