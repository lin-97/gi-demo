<template>
  <div>
    <a-card title="水平方向" :bordered="true" class="gi-mb">
      <template #extra>
    ...
    <a-card title="垂直方向" :bordered="true" class="gi-mb">
    ...
    <a-card title="垂直对齐-居中" :bordered="true" class="gi-mb">
      <GiSpace fill>
        <a-button type="primary" size="mini">按钮</a-button>
        <a-button type="primary" size="mini">按钮</a-button>
    ...
    <a-card title="垂直对齐-顶部" :bordered="true" class="gi-mb">
    ...
    <a-card title="垂直对齐-底部" :bordered="true" class="gi-mb">
