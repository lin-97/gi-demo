<template>
  <GiPageLayout margin>
    <GiForm :model-value="form" :columns="columns" search hide-fold-btn :suffix="false"
    ...
    <a-table class="g-full-table" row-key="id" page-position="bottom" :bordered="{ cell: true }" :loading="loading"
