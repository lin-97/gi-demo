...
const $com = {
  _init: function () {
    ...
    const str =
      "@keyframes zoomIn{from{transform:scale(0.5);opacity:0;}to{transform:scale(1);opacity:1;}}@keyframes zoomOut{from{transform:scale(1);opacity:1;}to{transform:scale(0.5);opacity:0;}}@keyframes fadeOut{from{opacity:1;}to{opacity:0;}}.com-zoom-in{animation:zoomIn;animation-duration:0.3s;}.com-zoom-out{animation-name:zoomOut;animation-duration:0.3s;}.com-dialog-wrapper{width:100%;height:100%;position:fixed;left:0;right:0;top:0;bottom:0;background-color:rgba(0,0,0,0.7);z-index:9999;display:flex;justify-content:center;align-items:center;}.com-dialog-wrapper.com-fade-out{animation-name:fadeOut;animation-duration:0.3s;}.com-dialog-wrapper .com-dialog{width:62.8rem;border-radius:1.4rem;background-color:#fff;}.com-dialog-wrapper .com-dialog .dialog-header{color:#121e33;font-size:3.6rem;line-height:5.4rem;padding:0 3.2rem;padding-top:5.6rem;text-align:center;}.com-dialog-wrapper .com-dialog .dialog-content{color:#676F7D;padding:3.2rem 3.2rem 5.6rem;font-size:3.4rem;line-height:4.6rem;}.com-dialog-wrapper .com-dialog .dialog-footer{height:11.2rem;display:flex;position:relative;}.com-dialog-wrapper .com-dialog .dialog-footer::before{content:'';width:100%;height:1px;transform:scaleY(0.5);background-color:#eceef2;position:absolute;left:0;top:0;}.com-dialog-wrapper .com-dialog .dialog-footer .button{height:100%;font-size:3.6rem;flex:1;display:flex;justify-content:center;align-items:center;position:relative;cursor: pointer;}.com-dialog-wrapper .com-dialog .dialog-footer .button:active{background-color:rgba(0,0,0,0.05);}.com-dialog-wrapper .com-dialog .dialog-footer .button.cancel{color:#121e33;}.com-dialog-wrapper .com-dialog .dialog-footer .button.confirm{color:#5c6198;}.com-dialog-wrapper .com-dialog .dialog-footer .button.confirm::before{content:'';width:1px;height:100%;transform:scaleX(0.5);background-color:#eceef2;position:absolute;left:0;top:0;}"
